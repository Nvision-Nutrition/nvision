...
// This is ignored because next auth provides its own capitolized functions
...
const isCorrectCredentials = (credentials) => {
  ...
  // and credentials.passowrd (hashed) is ===
  // to the hashed version associated with the username in the db
  // then its good to go
...
const options = {
  ...
  providers: [
    Providers.Credentials({
      ...
      name: 'Credentials',
      // The credentials is used to generate a
      // suitable form on the sign in page.
